...
public class ApiDataReader {
    public static String getValuesFromApi(String apiCode, String filterText) throws IOException {
        ...
        try {
            switch (apiCode) {
                ...
                case FLOATRATES_API_URL:
                    ...
                    result = FloatRatesXmlParser.getCurrencyRatesBaseUsd(apiContentStream, filterText);
                    break;
                case GUNFIRE_URL:
